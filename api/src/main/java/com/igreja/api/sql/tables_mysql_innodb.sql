...
CREATE TABLE IF NOT EXISTS  QRTZ_TRIGGERS (
  SCHED_NAME VARCHAR(50) NOT NULL,
  TRIGGER_NAME VARCHAR(75) NOT NULL,
  TRIGGER_GROUP VARCHAR(75) NOT NULL,
  JOB_NAME VARCHAR(75) NOT NULL,
  JOB_GROUP VARCHAR(75) NOT NULL,
  DESCRIPTION VARCHAR(250) NULL,
...
CREATE TABLE IF NOT EXISTS  QRTZ_CALENDARS (
  SCHED_NAME VARCHAR(50) NOT NULL,
  CALENDAR_NAME VARCHAR(75) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  QRTZ_JOB_LISTENERS (
  ...
  JOB_LISTENER VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  QRTZ_TRIGGER_LISTENERS (
  ...
  TRIGGER_LISTENER VARCHAR(50) NOT NULL,

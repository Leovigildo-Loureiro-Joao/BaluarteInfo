...
export const SlidesActiviy = ({data}) => {
    ...
    const Box=()=>{
        return  <div className=" w-[70vw] flex" >
                    <div id="total"  className=" w-[70vw]" >
                        <div className="m-10 flex gap-[10vw] w-[70vw] overflow-hidden"  style={{
    ...
    const [selectData,setData]=useState(<Box/>);
    return <> 

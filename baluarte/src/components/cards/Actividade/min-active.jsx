...
export const MinActive = ({titulo,descricao,img}) => {
    return (
        <MinActivyStyled className="activy-min flex flex-wrap flex-col min-h[400px]">
            <div id="capsula" className={`bg-no-repeat w-[20vw] min-w-[300px] max-h-[380px] h-screen bg-cover max-w-[350px] rounded-xl flex flex-col justify-end`} style={{backgroundImage :`url(${img})`}} >
